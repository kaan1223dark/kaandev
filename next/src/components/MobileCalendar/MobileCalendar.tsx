      ...
      <div className="grid grid-cols-7 gap-4">
        ...
        {monthGrid.flat().map((day, idx) => {
          ...
          return (
            <button
              key={idx}
              className={`flex w-full flex-col items-center rounded-lg py-2 text-center transition-all duration-300 ease-in-out ${isToday ? 'bg-[#fffadf] font-bold' : 'bg-gray-50'
            ...
            >
              ...
              {hasEvents && (
                <span
                  className={`flex h-6 w-6 items-center justify-center rounded-full px-2 py-1 text-xs ${isPast
